...
<x-guest-layout>
    ...
    @if(session()->has('success'))
        <div class="bg-green-50 border border-green-200 text-green-800 px-4 py-3 rounded-lg mb-4 mx-auto max-w-7xl mt-4">
    ...
    @if(session()->has('verification_required'))
        <div class="bg-blue-50 border border-blue-200 text-blue-800 px-4 py-3 rounded-lg mb-4 mx-auto max-w-7xl mt-4">
            <div class="flex items-center">
                <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
    ...
    @if(session()->has('error'))
        <div class="bg-red-50 border border-red-200 text-red-800 px-4 py-3 rounded-lg mb-4 mx-auto max-w-7xl mt-4">
            <div class="flex items-center">
                <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
    ...
    @volt
        <div>
            <section data-aos="fade-up" class="flex-grow flex flex-col items-center max-w-7xl mx-auto w-full mb-0 pb-0">
                <button
                    class="mt-16 mb-6 flex items-center space-x-2 border border-primary-600 text-primary-600 text-xs rounded-full px-4 pr-1.5 py-1.5 hover:bg-primary-50 transition"
                    type="button">
                    <span>
                ...
                <h1
                    class="text-center text-gray-900 font-bold text-3xl sm:text-4xl md:text-5xl max-w-2xl leading-tight">
                    Temukan
                ...
                <div class="flex flex-col sm:flex-row gap-4 mt-8">
                    <a href="{{ route('catalog') }}"
                        class="bg-primary-600 text-white px-6 py-2.5 rounded-full text-sm font-medium flex items-center justify-center space-x-2 hover:bg-primary-700 transition">
                        <span>
                            Jelajahi Koleksi
                        </span>
                    ...
                    <a href="/admin/register"
                        class="border border-primary-600 text-primary-600 px-6 py-2.5 rounded-full text-sm font-medium flex items-center justify-center space-x-2 hover:bg-primary-50 transition">
                        <span>
                ...
                <img class="rounded-[50px] mt-16 h-72 w-full object-cover rounded-b-none max-w-5xl"
                ...
                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 mt-16 w-max mx-auto">
                    <div class="hover:bg-slate-50 h-16 w-44 sm:w-60 sm:h-20 border border-slate-200 border-t-0 border-l-0">
                    </div>
                    <div
                        class="hover:bg-slate-50 h-16 w-44 sm:w-60 sm:h-20 border border-slate-200 border-t-0 border-x-0 md:border-r">
                    </div>
                    <div
                        class="hover:bg-slate-50 h-16 w-44 sm:w-60 sm:h-20 border border-slate-200 hidden md:flex md:border-t-0 md:border-x-0 lg:border-r">
                    </div>
                    <div
                        class="hover:bg-slate-50 h-16 w-44 sm:w-60 sm:h-20 border border-slate-200 hidden lg:block lg:border-x-0 lg:border-t-0">
                    </div>
                    <div
                        class="hover:bg-slate-50 h-16 w-44 sm:w-60 sm:h-20 border border-slate-200 hidden xl:block xl:border-t-0 xl:border-r-0">
                    </div>

                    <div
                        class="hover:bg-slate-50 h-16 w-44 sm:w-60 sm:h-20 border border-slate-200 hidden xl:block xl:border-y-0 xl:border-l-0">
                    </div>
                    <div
                        class="hover:bg-slate-50 h-16 w-44 sm:w-60 sm:h-20 border border-slate-200 hidden lg:block lg:border-y-0 lg:border-l-0">
                    </div>
                    <div
                        class="hover:bg-slate-50 h-16 w-44 sm:w-60 sm:h-20 border border-slate-200 hidden md:block md:border-l-0 md:border-y-0">
                    </div>
                    <div
                        class="hover:bg-slate-50 h-16 w-44 sm:w-60 sm:h-20 border border-slate-200 border-x-0 border-y-0 border-r xl:border-r-0">
                    </div>
                    <div
                        class="hover:bg-slate-50 h-16 w-44 sm:w-60 sm:h-20 border border-slate-200 border-x-0 border-y-0 xl:border-l">
                    </div>
                </div>
            </section>
            ...
            <section class="w-full items-center max-w-6xl mx-auto px-4">
                ...
                <div data-aos="fade-up" class="mx-auto lg:max-w-7xl md:max-w-4xl sm:max-w-xl max-sm:max-w-sm">
                    <div class="flex items-center justify-between w-full mb-8">
                        ...
                        <a href="{{ route('catalog') }}" class="text-lg font-semibold text-primary-600 underline">
                            Lainnya
                        </a>
                    </div>
            ...
            <section data-aos="fade-up" class="w-full items-center max-w-6xl mx-auto px-4">
                <div class="mt-20">
                    <div class="flex flex-col items-center text-center">
                        ...
                        <h2 class="text-2xl sm:text-3xl text-gray-600 font-semibold px-4">
                            Jelajahi Kategori Favorit
                        </h2>
                        <div
                            class="flex items-center justify-center max-w-full sm:max-w-md mx-auto px-4 sm:px-6 gap-2 border border-gray-200 text-slate-400 rounded-full py-2 mt-6 text-xs sm:text-sm text-center leading-relaxed">
            ...
            <section class="w-full items-center max-w-6xl mx-auto px-4">
                <div id="about" data-aos="fade-up"
                    ...
                    <div class="flex flex-col items-center md:items-start">
                        ...
                        <div
                            class="flex flex-wrap items-center justify-center p-1.5 rounded-full border border-slate-600 text-white text-xs">
                            ...
                            <p class="-translate-x-2 text-gray-900">Digunakan oleh siswa-siswi SMA kami
                            </p>

                        </div>

                        <h1
                            class="text-center md:text-left text-5xl leading-[68px] md:text-6xl md:leading-[84px] font-medium max-w-xl text-gray-900">

                            Sistem Perpustakaan Modern

                        </h1>

                        <p class="text-center md:text-left text-sm text-gray-900 max-w-lg mt-2">
                    ...
                    <img src="https://darul-muttaqien.com/wp-content/uploads/2025/02/perpus-2.jpg"
                        ...
                        class="max-w-xs sm:max-w-sm lg:max-w-md transition-all duration-300 object-cover rounded-2xl"
                        style="height: 400px;">
            ...
            <section class="w-full items-center max-w-6xl mx-auto px-4">
                <div id="contact" data-aos="fade-up-left"
                    ...
                    <img class="max-w-sm w-full rounded-xl object-cover"
                    ...
                    <div>
                        ...
                        <h1 class="text-3xl text-gray-900 font-semibold">Butuh Bantuan?</h1>
                        ...
                        <div tabindex="0"
                            class="collapse collapse-arrow bg-base-100 border-base-300 border text-gray-900">
            ...
            <section data-aos="fade-up">
                <h1 class="text-3xl font-semibold text-center text-gray-900 mx-auto">Gallery Kegiatan
                    Perpustakaan</h1>
                <p class="text-sm text-slate-500 text-center mt-2 max-w-lg mx-auto">Dokumentasi kegiatan literasi dan
            ...
            <section data-aos="fade-up"
                class="flex flex-col items-center justify-center mx-auto max-md:mx-2 max-md:px-2 max-w-5xl w-full text-center rounded-2xl py-20 my-20 md:py-24 bg-cover bg-center bg-no-repeat"
                style="background: #f28b16;
background: linear-gradient(329deg, rgba(242, 139, 22, 1) 0%, rgba(255, 186, 145, 1) 67%, rgba(247, 247, 247, 1) 100%);">
                <h1 class="text-2xl md:text-3xl font-medium text-white max-w-2xl">Raih Prestasi Akademik Lebih Baik dengan
                    Perpustakaan Digital SMA</h1>
                <div class="h-[3px] w-32 my-1 bg-gradient-to-l from-transparent to-white"></div>
                ...
                <a href="{{ route('catalog') }}" class="px-10 py-3 mt-4 btn rounded-full">
                    Mulai Sekarang
                </a>
            </section>
        </div>
