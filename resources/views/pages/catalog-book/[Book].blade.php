...
<x-guest-layout>
    @volt
        <div>
            ...
            <div class="pt-20">
                        ...
                        <div class="w-full lg:sticky top-0 lg:col-span-2">
                            <div class="flex flex-col">
                                <div class="bg-white  rounded-lg shadow-lg p-8">
                                    <div class="aspect-[3/4] bg-gray-100  rounded-lg overflow-hidden mb-6">
                        ...
                        <div class="w-full lg:col-span-3">
                            <div>
                                ...
                                <div class="space-y-4 mb-6">
                                    @if ($book->synopsis)
                                        <h3 class="text-lg font-bold text-gray-900 ">Sinopsis</h3>
                ...
                <div
                    class="w-full max-w-7xl mx-auto mt-12 border px-6 py-12 bg-white  rounded-lg shadow-lg">
 ...
 w-5 h-5 text-gray-400 text-xl mr-3 mt-0.5"></i>
                                        ...
                                        <div class="flex items-start">
                                            <i class="iconoir-calendar w-5 h-5 text-gray-400 text-xl mr-3 mt-0.5"></i>
                                            <div>
                                                <p class="text-gray-900  text-sm font-semibold">
                                                    Tahun Terbit
                                                </p>
 ...
 w-5 h-5 text-gray-400 text-xl mr-3 mt-0.5"></i>
                                        ...
                                        <div class="flex items-start">
                                            <i class="iconoir-loft-3d w-5 h-5 text-gray-400 text-xl mr-3 mt-0.5"></i>
                                            <div>
                                                <p class="text-gray-900  text-sm font-semibold">
                                                    Lokasi Rak
                                                </p>
                                        ...
                                        <div class="flex items-start">
                                            <i class="iconoir-book w-5 h-5 text-gray-400 text-xl mr-3 mt-0.5"></i>
                                            <div>
                                                <p class="text-gray-900  text-sm font-semibold">
                                                    Jenis Buku
                                                </p>
                                ...
                                <div class="space-y-6">
                                    <h3 class="text-lg font-bold text-gray-900 ">Informasi Peminjaman
                                    </h3>

                                    <div class="space-y-4">
                                        <div class="flex items-start">
                                            <i class="iconoir-timer w-5 h-5 text-gray-400 text-xl mr-3 mt-0.5"></i>
                                            <div>
                                                <p class="text-gray-900  text-sm font-semibold">Durasi
                                                    Peminjaman</p>
                                                <p class="text-sm text-gray-600 ">Maksimal
                                                    {{ $setting->limit_day }} hari</p>
                                            </div>
                                        </div>

                                        <div class="flex items-start">
                                            <i class="iconoir-refresh w-5 h-5 text-gray-400 text-xl mr-3 mt-0.5"></i>
                                            <div>
                                                <p class="text-gray-900  text-sm font-semibold">
                                                    Perpanjangan</p>
                                                <p class="text-sm text-gray-600 ">Dapat diperpanjang
