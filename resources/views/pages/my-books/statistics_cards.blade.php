<div data-aos="fade-up" class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
    ...
    {{-- Sedang Dipinjam --}}
    <x-card compact="true" class="border border-gray-300 dark:border-gray-600 bg-gray-100 dark:bg-gray-900/40 rounded-xl">
        <x-slot:body>
    ...
    {{-- Terlambat --}}
    <x-card compact="true" class="rounded-xl border border-gray-300 dark:border-gray-600 bg-gray-100 dark:bg-gray-900/40">
        <x-slot:body>
            <div class="flex items-center justify-between">
                <div>
                    <div class="text-3xl font-bold text-gray-700 dark:text-gray-300">
