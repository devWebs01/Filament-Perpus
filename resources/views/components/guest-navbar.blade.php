      ...
      <div
          ...
          <nav id="menu"
              ...
              <div class="flex flex-col md:flex-row gap-4 md:gap-8 w-full md:w-auto">
                  <a class="hover:text-warning-600 transition-colors py-2 text-center"
                      href="{{ route('welcome') }}">
                      Beranda
                  </a>
                  <a class="hover:text-warning-600 transition-colors py-2 text-center"
              ...
              @guest
                  <div
                      class="flex flex-col md:hidden gap-3 w-full px-6 border-t border-gray-200 pt-4 mt-4">
                      ...
                      <div class="space-y-2">
                          ...
                          <a href="{{ route('my-books') }}"
                              ...
                              @if ($this->overdueCount > 0)
                                  <span class="badge badge-sm badge-error ml-1">{{ $this->overdueCount }}</span>
                              @endif
                          </a>
                          <a href="{{ route('my-bookmarks') }}"
                              ...
                              @if ($this->bookmarkCount > 0)
                                  <span class="badge badge-sm badge-warning ml-1">{{ $this->bookmarkCount }}</span>
                              @endif
                          </a>
              ...
              @else
                  ...
                  <div class="dropdown dropdown-end">
                      ...
                      <ul tabindex="0"
                          ...
                          <li>
                              <a href="{{ route('profile') }}"
                                  class="flex items-center text-black gap-2 justify-between">
                          ...
                          <li>
                              <a href="{{ route('my-books') }}"
                                  ...
                                  @if ($this->overdueCount > 0)
                                      <span class="badge badge-sm badge-error">{{ $this->overdueCount }}</span>
                                  @endif
                              </a>
                          </li>
                          <li>
                              <a href="{{ route('my-bookmarks') }}"
                                  ...
                                  @if ($this->bookmarkCount > 0)
                                      <span class="badge badge-sm badge-warning">{{ $this->bookmarkCount }}</span>
                                  @endif
                              </a>
                          </li>
