...
return [
    ...
    */
    ...
    'ascii' => 'Field :attribute hanya boleh berisi karakter alfanumerik single-byte dan simbol.',
    ...
    'between' => [
        'array' => 'Field :attribute harus memiliki antara :min hingga :max item.',
        'file' => 'Field :attribute harus antara :min hingga :max kilobita.',
        'numeric' => 'Field :attribute harus antara :min hingga :max.',
        'string' => 'Field :attribute harus antara :min hingga :max karakter.',
    ],
    'boolean' => 'Field :attribute harus bernilai true atau false.',
    'can' => 'Field :attribute berisi nilai yang tidak berizin.',
    'confirmed' => 'Konfirmasi field :attribute tidak cocok.',
    'contains' => 'Field :attribute kekurangan nilai yang diperlukan.',
    ...
    'digits_between' => 'Field :attribute harus antara :min hingga :max digit.',
    'dimensions' => 'Field :attribute memiliki dimensi gambar yang tidak valid.',
    'distinct' => 'Field :attribute memiliki nilai duplikat.',
    'doesnt_contain' => 'Field :attribute tidak boleh mengandung nilai berikut: :values.',
    ...
    'gte' => [
        ...
        'file' => 'Field :attribute harus lebih besar atau sama dengan :value kilobita.',
    ...
    'in_array_keys' => 'Field :attribute harus memiliki setidaknya satu dari kunci berikut: :values.',
    ...
    'max' => [
        ...
        'file' => 'Field :attribute tidak boleh lebih besar dari :max kilobita.',
    ...
    'uppercase' => 'Field :attribute harus huruf kapital.',
